public class B3_HalfTheRed extends World {
    ...
    public void go() {
        ...
        System.out.println(plane.howMuchRed()); // howMuchHRed is a method that tells us the R value of the planes current pixel

        for (int row = 153; row < 218; row = row + 1) {
            for (int col = 130; col < 488; col++) {
